...
class _Stage4ScreenState extends State<Stage4Screen>
  ...
  void _generateNextOptions() {
    ...
    final random = Random();
    _nextOptions = [_nextWord!.english];
  ...
  void _checkAnswer(String selected) {
    ...
    final isCorrectAnswer = selected == word.english;
            ...
            return Transform.translate(
              ...
              child: Column(
                children: options.map((option) {
                  ...
                  final isCorrect = option == word.english && isSelected;
                  final isWrong =
                      option == _selectedOption && option != word.english;
